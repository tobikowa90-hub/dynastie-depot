...
| Block | Score | Details |
|-------|-------|---------|
| Fundamentals | 35/50 | P/B 1.44x (Buyback-Zone <1.5x). Book Value CAGR +10% 5J. Interest Income $39.98B (T-Bill Float). Netto-Cash ~$344B. CapEx/OCF 45.6% (BNSF+BHE, kein FLAG). Goodwill 6.8% |
| Moat | 19/20 | Float-Leverage einzigartig, BNSF Efficient Scale (Railroad-Duopol), 60J Capital-Allocation. –1 Nachfolge-Risiko Greg Abel |
| Technicals | 4/10 | -11.1% vom ATH $539.80, unter 200D-MA, PT-Upside ~+13.5% |
| Insider | 9/10 | Greg Abel Open-Market $15.3M (90d) — starkes Alignment. $0 diskr. Selling. Buffett ~15% Ownership |
