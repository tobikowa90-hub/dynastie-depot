...
> 36 active + 5 deferred-Stub + 1 reject-inventarisiert = **42 Quellen inventarisiert** → 30 Befunde → operative Konsequenzen für das Dynasty-Depot.
...
> **Stand 2026-05-10 Phase-D-1-Confidence-Upgrade-Pass:** Voll-PDF-Read von Peters/Taylor 2016-WP-Version (= JFE 2017 methodisch identisch) + DHS 2020 lieferte 9 Sachfehler-Korrekturen in B29/B30-Source/Concept-Pages (u.a. Sample-Perioden 1975-2011 statt 1975-2014; PEAD-CAR statt -SUE; Spanning 31/34 statt 24/30; Cumulant-Estimator statt GMM; Half-Life 6-9 Monate statt ~3 Monate; FIN-Multi-Year-Issuance-Index nicht single-quarter Buyback). Vault-Backfill mit 6 neuen Pages: 5 deferred-Stubs (Eisfeldt/Papanikolaou 2013 OrgCap, Barillas/Shanken 2015 Which-Alpha, Eisfeldt/Kim/Papanikolaou 2020 Intangible-Value, Chen/Pelger/Zhu 2019 DL-Asset-Pricing, Crouzet/Eberly/Eisfeldt/Papanikolaou 2022 JEP) + 1 Reject-Inventarisiert (Bryzgalova/Pelger/Zhu 2023 AP-Trees). **Status-Änderungen:** IV-2020 von D-3 SOURCE-ONLY auf **D-2 active-deferred** hochgestuft (User-Direktive, Cluster-Aktivierung mit EP-2013 für Q3-2026-V-Trigger). CEEP-2022 als **SOURCE-ONLY-Co-Anker für B29** (Goodwill-Brücke jetzt primär-belegt; vormaliger Restvorbehalt „Crouzet/Eberly 2019 Brücke" geschlossen). 36 → 36 active + 5 deferred-Stub + 1 reject-inventarisiert = **42 Quellen inventarisiert**; 30 Befunde unverändert (Stubs sind Vault-Inventur, kein neuer B-Befund). 11 neue Author-Entity-Stubs (Eisfeldt, Papanikolaou, Kim, Barillas, Shanken, Crouzet, Eberly, Chen, Pelger, Zhu, Bryzgalova). SKILL.md §410-Block um 3 Präzisierungen erweitert (Misspezifikation statt Hayashi-Ablehnung; 40%-Schwelle als DEFCON-Konvention; CEEP-2022-Brücke). **Vault-only-Phase** — DEFCON v3.7 unverändert, 11 Satelliten-Scores unverändert, Sparraten unverändert.
...
## 30-Befunde Entscheidungsmatrix (Stand: 10.05.2026, post Phase-D-1-Confidence-Upgrade-Pass)
...
| **B29** | Total q (physisch + intangibles Capital) korrigiert misspezifiziertes Investment-q-Modell (Prediction 4: K^tot/K^phy im Residuum erzeugt downward-biased q-slopes); klassisches Tobin's q ist Mess-Artefakt; Goodwill bei M&A-Compoundern = Lower-Bound externalisiertes Intangibles-Capital (CEEP-2022 JEP Non-Rivalry + Limited-Excludability-Brücke; 40%-Schwelle = DEFCON-Konvention, nicht Peters/Taylor-Empirie) | [[Peters-Taylor-2017-Intangible-Capital]] + Co-Anker [[Crouzet-Eberly-Eisfeldt-Papanikolaou-2022-Economics-Intangible-Capital]] | `active-scoring-validation` — Fundamentals-Block (50 Pt.) §410 IC-bereinigte ROIC | §410-Bereinigung wissenschaftlich fundiert statt rein Präzedenz-Argument (AVGO 30.04.); Tie-Break IC-GW vs Regel-4 (40%-Goodwill-Asset-Schwelle als DEFCON-Konvention markiert) theoretisch erklärt | Keine Score-Änderung; SKILL.md §410-Block trägt B29-Anker explizit (Phase D-1 2026-05-09 + Confidence-Upgrade 2026-05-10 mit 3 Präzisierungen); Phase D-2 EP-2013 OrgCap + EKP-2020 IV active-deferred-D2 (Cluster Q3-2026-V-Trigger) |
| **B30** | DHS-3-Faktor-Modell (MKT+PEAD+FIN) spannt 31/34 Anomalien (sig. α 5%, GRS F=1,61 vs FF-5 F=2,60), Sample 1972:07-2014:12 (510 Monate); PEAD = Short-Horizon Underreaction via 4-Tage-CAR um Earnings, t−2 bis t+1 (Decay 6-9 Monate, Tabelle 5 Panel A; CAR-basiert hat stärkere Erklärungskraft als SUE-basiert per Footnote 13); FIN = Long-Horizon Manager-Timing via Multi-Year-Net-Issuance-Index (1Y Pontiff/Woodgate + 5Y Daniel/Titman, NICHT single-quarter Buyback-Authorization); Long-/Short-Asymmetrie Tabelle 10 (avg βF IN +0,03 long vs −0,27 short); Klammer für B11/B26/B27/B28 | [[Daniel-Hirshleifer-Sun-2020-Behavioural-Factors]] | `active-scoring-validation` — Sentiment-Block (10 Pt.) + Insider-Block (5 Pt.) | Buyback ≠ Sentiment-Bonus (V-Q2-28.04. + BRK.B-04.05.-Methodology-Lehren); Earnings-Wait-Discipline §19.1 wissenschaftlich verankert via PEAD-Theorie | Keine Score-Änderung; Anti-Buyback-Disziplin im SKILL.md §27.7-Cross-Reference verankert (Phase D-1 Final-Closure 2026-05-09); SKILL-Output-Template Sentiment+Insider B30-Klammer-Notation deferred bis Schritt-3-Edit-Slot; FIN-Sub-Score §28.1-Migration deferred (Long-Only-Konversion erfordert Backtest-Validierung wegen Short-Side-70-80%-Faktor-Loadings) |
...
| B29 | `active-scoring-validation` | Fundamentals-Block (50 Pt.) — §410 IC-bereinigte ROIC; Tie-Break IC-GW vs Regel-4 (40%-Goodwill-Asset-Schwelle als DEFCON-Konvention markiert, nicht Peters/Taylor-Empirie) | Total-q-Theorie als wissenschaftliche Fundierung der seit AVGO-30.04.2026 operativen Goodwill-Bereinigung; ökonomische Brücke „Goodwill = Lower-Bound externalisierte Intangibles" via [[Crouzet-Eberly-Eisfeldt-Papanikolaou-2022-Economics-Intangible-Capital]] (CEEP-2022 JEP Non-Rivalry + Limited-Excludability) — vormaliger Restvorbehalt „Crouzet/Eberly 2019 Brücke" geschlossen; SKILL.md §410-Block trägt B29-Anker explizit (Phase D-1 2026-05-09 + Confidence-Upgrade 2026-05-10 mit 3 Präzisierungen: Misspezifikation/Prediction-4 statt Hayashi-Ablehnung; 40%-Schwelle als DEFCON-Konvention; CEEP-2022-Brücke) |
...
## Quellen-Übersicht (42 Quellen inventarisiert: 36 active + 5 deferred-Stub + 1 reject-inventarisiert — Stand: 10.05.2026 — Phase A + C-1 + D-1 + D-1-Confidence-Upgrade-Pass)
...
| [[Eisfeldt-Papanikolaou-2013-Organization-Capital]] | 2013 | Organization Capital = SG&A-akkumuliertes Schlüsselpersonal-Produktionskapital; High-O/K-Firmen +4,6 pp p.a. Excess-Returns; OMK-Long-Short-Sharpe ~Markt, unkorreliert mit FF/Carhart | Fundamentals-Block (50 Pt.) — `design-context` OrgCap-Sub-Score-Anker | Phase-D-2 active-deferred-D2 ← NEU 2026-05-10 Vault-Inventur (Voll-PDF-Stub) |
| [[Barillas-Shanken-2015-Which-Alpha]] | 2015 | Bei Modellvergleich mit getradeten Faktoren ist Test-Asset-Alpha-Wettbewerb irrelevant; nur „wie gut preist Modell A die excluded factors von Modell B" zählt | Validation-Methode — `meta-gate` §29.4-Erweiterung Bayesian-Tie-Break | Phase-D-2 meta-gate-deferred-D2 ← NEU 2026-05-10 Vault-Inventur (Voll-PDF-Stub) |
| [[Eisfeldt-Kim-Papanikolaou-2020-Intangible-Value]] | 2020 | Intangibles-augmented HML_INT (Book-Equity + kumulierte Intangible-Asset-Stock auf SG&A) liefert 2,4% IRR-Alpha + Sharpe 0,40 vs HML_FF; post-2007 HML_FF nicht-signifikant, HML_INT robust | Fundamentals-Block — `design-context` Intangible-Adjusted-Value-Härtung (B29-Cluster) | Phase-D-2 active-deferred-D2 ← NEU 2026-05-10 Vault-Inventur (User-Direktive D-3→D-2-Hochstufung; Cluster mit EP-2013 für Q3-2026-V-Trigger) |
| [[Chen-Pelger-Zhu-2019-Deep-Learning-Asset-Pricing]] | 2019 | Deep-SDF (FFN+LSTM+GAN mit No-Arbitrage-Constraint) liefert OoS-Sharpe 2,6 vs FF-5 0,8 + cross-sectional R²>90% auf 46 Anomalie-Decile-Sortierungen | Architektur-Referenz (DEFCON-orthogonal Long-Short) — `future-arch` Backtest-Validation-Wave | Phase-D-3 source-only-deferred-D3 ← NEU 2026-05-10 Vault-Inventur (Voll-PDF-Stub) |
| [[Crouzet-Eberly-Eisfeldt-Papanikolaou-2022-Economics-Intangible-Capital]] | 2022 | Intangibles haben zwei distinguishing properties: Non-Rivalry in Use + Limited Excludability; Goodwill = Lower-Bound externalisierte Intangibles via Storage-Medium + Limited-Excludability-Argumentation | Fundamentals-Block (50 Pt.) — SOURCE-ONLY-Co-Anker für B29 (Goodwill-Brücke jetzt primär-belegt) | SOURCE-ONLY (anchors B29) ← NEU 2026-05-10 Phase-D-1-Confidence-Upgrade |
| [[Bryzgalova-Pelger-Zhu-2023-Forest-Through-Trees]] | 2023 | AP-Trees als Test-Asset-Konstruktion für Asset-Pricing-Modellvergleiche (Median-Splits + SDF-Spanning-Pruning + Robust-MVE-Optimierung); OoS-Sharpe 2-3x über Standard-Sorts (Long-Short-Managed-Portfolios, NICHT Long-Only-Stock-Picking) | DEFCON-orthogonal — `design-rejected` (Long-Only-Stock-Picking-Pfad fehlt) | REJECT-INVENTARISIERT ← NEU 2026-05-10 Vault-Inventur (Latent-Wert für 2028-Review-Gate Backtest-Methodology-Roadmap) |
...
Crouzet-Eberly-Eisfeldt-Papanikolaou-2022 ─► [[Intangible-Adjusted-Value]] ──► §410 Co-Anker (B29 Goodwill-Brücke primär-belegt, SOURCE-ONLY)
Eisfeldt-Papanikolaou-2013 ──────► [[Intangible-Adjusted-Value]] ─────► OrgCap-Sub-Score (design-context, deferred D-2 Cluster Q3-2026)
Eisfeldt-Kim-Papanikolaou-2020 ──► [[Intangible-Adjusted-Value]] ─────► HML_INT-Härtung (design-context, deferred D-2 Cluster Q3-2026)
Barillas-Shanken-2015 ───────────► §29.4 Bayesian-Tie-Break ─────────► meta-gate (deferred D-2, 2028-Review-Gate)
Chen-Pelger-Zhu-2019 ────────────► Backtest-Validation-Wave ─────────► future-arch (deferred D-3, source-only)
Bryzgalova-Pelger-Zhu-2023 ──────► REJECT-INVENTARISIERT ────────────► DEFCON-orthogonal (AP-Trees Long-Short, Latent für 2028)
```
...
| 2026-05-10 | **Phase-D-1-Confidence-Upgrade-Pass** (post-Compact, sehr-spät 09.05. → früh 10.05.): User stellte 8 Voll-PDFs in `raw/papers/` zur Verfügung (+1 zusätzlich CEEP-2022 nach Duplikat-Klärung). 2 parallele Subagents (Gemini A für D-1-Upgrade, Researcher B für D-2/-3-Backfill + Reject) lieferten Voll-Reports mit **9 Sachfehler-Korrekturen** in B29/B30-Source/Concept-Pages (Sample-Perioden 1975-2011 + 1972:07-2014:12 510 Monate; PEAD-CAR statt -SUE per Footnote 13; Spanning 31/34 statt 24/30; Cumulant-Estimator statt GMM; Half-Life 6-9 Monate statt ~3 Monate; FIN-Multi-Year-Issuance-Index nicht single-quarter Buyback). Vault-Backfill mit 6 neuen Pages: 5 deferred-Stubs (EP-2013 OrgCap, BS-2015 Which-Alpha, EKP-2020 Intangible-Value, CPZ-2019 DL-Asset-Pricing, CEEP-2022 JEP Economics-Intangible-Capital) + 1 Reject-Inventarisiert (BPZ-2023 Forest-Through-Trees) + 11 Author-Entity-Stubs in `wiki/entities/` (Eisfeldt, Papanikolaou, Kim, Barillas, Shanken, Crouzet, Eberly, Chen, Pelger, Zhu, Bryzgalova). **Status-Änderungen:** IV-2020 von D-3 SOURCE-ONLY auf **D-2 active-deferred** hochgestuft (User-Direktive 10.05., Cluster-Aktivierung mit EP-2013 für Q3-2026-V-Trigger). CEEP-2022 als **SOURCE-ONLY-Co-Anker für B29** — Goodwill-Brücke jetzt primär-belegt (vormaliger Restvorbehalt „Crouzet/Eberly 2019 Brücke" geschlossen). 36 → 36 active + 5 deferred-Stub + 1 reject-inventarisiert = **42 Quellen inventarisiert**; 30 Befunde unverändert (Stubs sind Vault-Inventur, kein neuer B-Befund). SKILL.md §410-Block um 3 Präzisierungen erweitert (Misspezifikation/Prediction-4 statt Hayashi-Ablehnung; 40%-Schwelle als DEFCON-Konvention; CEEP-2022-Brücke). Gemini-Cross-Sync-Audit (80% Confidence) fand 4 Drift-Kategorien (Synthesis-PARTIAL Kategorie A 9 Items + Vault index/log Kategorie B 5 Items + Backlink/Frontmatter Kategorie C 8 Items + Subtle Drifts Kategorie D 7 Items) — alle in Resume-Session 10.05. abgearbeitet inkl. Quick-Fixes (raw_path-Doppelung, medium/created/updated-Felder, Stale-Wortlaut Author-Entities-Deferred entfernt, Crouzet-Eberly-2019 → CEEP-2022, Kuchler → EKP-2020, Sample 1972-2017 → 1972:07-2014:12). Codex-Single-Pass-Review via `codex:codex-rescue` Subagent (96%-Gate per User-Direktive ≥95%) post-Vollendung. **Vault-only-Phase** — DEFCON v3.7 unverändert, 11 Satelliten-Scores unverändert, Sparraten unverändert. |
