...
**Stand:** 04.09.2026 (**AVGO Q3 FY26 Vollanalyse §19.1: Score 56→59, DEFCON 2 unverändert, FLAG bleibt aktiv — Resolve-Gate verfehlt** [$33,69M diskr. 90d > $20M]; Rate 0€ unverändert. Kurs $357,16 [Schluss 03.09.]. Alle übrigen Zeilen dieser Datei stehen weiterhin auf dem Juni-Stand — siehe Warnung bei den 30-Tage-Triggern. Vorher: 09.06.2026 Earnings-Kalender-Sync via `03_Tools/earnings_calendar.py` [yfinance+Override, SSoT]: alle „Nächster Trigger"-Termine auf Tool-Kanon — ASML 15.07. → NOW/TMO 22.07. → V 28.07. → MSFT/APH/RMS/KYCCF 29.07. → SU/AMZN 30.07. → BRK.B 01.08. → ZETA 04.08. → AVGO 03.09. NOW yf-soft [TipRanks 29.07]. Date-only, kein Score-Event. Umstrukturierung-2027 Phase A: Roster 12→13, Equal-Weight→3-Tier, Split 60/35/5; letzter Score-Move AVGO 04.06. Q2 FY26 53→56 FLAG-bleibt). Score-/FLAG-/Sparraten-Chronik aller Moves seit 17.04. → CORE-MEMORY §12.X + git log (kanonische Detail-Quelle).
...
| **T1** | AVGO | **59** | 🟠 2 | **0€** | 🔴 Insider-Selling 90d **$33,7M** (27.04., Re-Check 04.09.) | **Q4 FY26 09.12.** (amc, IR-confirmed im Q3-Call) — Q3 02.09. Vollanalyse 04.09.: 56→59, FLAG-Resolve-Gate **verfehlt** ($33,7M > $20M; Rückgang von $106,4M, aber $29,2M davon allein Brazeal/CLO in 3 Tranchen ohne 10b5-1). §12.1 |
...
- **AVGO FLAG-Watch — Resolve-Gate am 04.09.2026 verfehlt, nächstes Gate Q4 FY26 09.12.** Diskretionäres Selling 90d **$33,69M** gegen $20M-Schwelle (Rückgang von $106,4M am 27.04., aber nicht unter die Grenze). **Konzentration ist das eigentliche Signal:** $29,19M der $33,69M entfallen auf **eine** Person — Brazeal (Chief Legal & Corp Affairs Officer) in drei Tranchen (25.06. $9,68M · 08.07. $9,48M · 10.07. $10,03M), alle ohne 10b5-1-Marker. Plan-Verkäufe $250M/90d korrekt ausgeschlossen. Netto 6M −$639,7M, ein einziger Open-Market-Kauf ($0,37M). **Resolve-Pfad:** fallen die Juni/Juli-Tranchen aus dem 90-Tage-Fenster (ab ~08.10.) und kommt nichts nach, unterschreitet die Metrik die Schwelle mechanisch — das Gate am 09.12. ist damit realistisch erreichbar, **ohne** dass sich das Verhalten ändern muss. Genau deshalb ist der Zwischenstand kein Entwarnungssignal. Q3-Vollanalyse 04.09.: Score 56→59, D2, Rate 0€ (Detail §12.1).
...
| ~~03.09.~~ **erledigt 04.09.** | AVGO | B | Q3 FY26 Vollanalyse DONE — 56→59, D2, FLAG bleibt (Resolve-Gate verfehlt, $33,7M > $20M). **Nächster Trigger 09.12.** (amc, im Q3-Call bestätigt) |

> ⚠️ **Die übrigen Zeilen dieser Tabelle stammen vom 09.06. und sind sämtlich abgelaufen** (ASML 15.07. bis ZETA 04.08.). Sie sind **nicht** nachgeführt — Kalender-Nachführung ist Teil von PIPELINE #83, nicht dieses Score-Events. Vor der nächsten Trigger-Entscheidung `03_Tools/earnings_calendar.py --check` laufen lassen; diese Tabelle ist bis dahin keine belastbare Quelle.


---

*🦅 PORTFOLIO.md v1.6 | Dynasty-Depot | Live-State — default-load bei Session-Start | Stand: 2026-09-04 (**AVGO Q3 FY26 Vollanalyse, §19.1 Tag +2** [Call lief 02.09. amc, nicht 03.09. wie im Kalender geführt]: Score **56→59**, DEFCON 🟠 2 unverändert, **FLAG-Resolve-Gate verfehlt** — diskr. Selling 90d $33,69M > $20M-Schwelle, Sparrate 0€ unverändert. Score-Treiber: Fwd P/E 22,7→20,65 verlässt den Quality-Trap-Korridor 22–30 [Sub-Score 1→4], FCF-Yield 1,6→2,32% [1→3], Bilanz 5→6 [Net Debt/EBITDA 1,41→0,68x nach $5,6B Tilgung], ATH-Distanz −27,85% [3→4] — gegen Technicals-Verfall: Kurs unter 200MA [3→0] und Rel. Stärke 38pp→+0,8pp [3→1]. Q3: Rev $29,6B +86%, AI-Semi $16,7B +221%, OpM 67,9% Rekord, FCF $13,7B; Guidance FY27-AI $115B / FY28 $230B. Vorher: 2026-06-13 KYCCF O3-Vollanalyse: Score 67/🟡 D3, kein FLAG, Tier-2-Rate 32€ unverändert [Platzhalter war voll gefunded → Funded-Σ 210€ stabil]; Primärquelle JGAAP FY26; ersetzt DEFCON-3-Platzhalter; O3-Backlog jetzt NOW/ZETA. Vorher: 2026-06-12 exUSA-Re-Add: EXUS @82€ reaktiviert als US-Hedge, Slots 19→20, intern aus IWDA/AVGC/JEDI finanziert, ETF-Block 616€ unverändert; Rebalancing_Tool_v4.0 SSoT. Vorher: 2026-06-09 Earnings-Kalender-Sync via `earnings_calendar.py` [yfinance+Override SSoT]; Tool-Regex-Bug für 7-Spalten-3-Tier-Tabelle gefixt; date-only, kein Score-Event. Vorher: 2026-06-08 Umstrukturierung-2027 Phase A 13-Roster + 3-Tier + 60/35/5. Detail-Chronik → CORE-MEMORY §12 + git log + score_history.jsonl)*
