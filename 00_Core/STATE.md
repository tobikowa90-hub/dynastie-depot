...
**Plan-v1.2-Status:** committed `<commit-sha>` (atomarem Plan-v1.2-Commit + Folge-Commit META-REVIEW-Move). Re-Audit-Trigger: post-Commit + Cleanup-Welle, broken-Refs-Delta in Cleanup-Track-Item-Eintrag dokumentiert.
