...
- **13.05. (Mi) ✅ Ruflo Hard-Rollback DONE** (System-Event, scoring-neutral). Substrate komplett deinstalliert, replaced durch context-mode + claude-mem. DEFCON v3.7 + Scores + Sparraten unverändert. Detail → CORE-MEMORY §13.
...
*🦅 STATE.md Hub v2.3 | Dynasty-Depot | Stand 2026-05-13 post-Ruflo-Sunset.*
