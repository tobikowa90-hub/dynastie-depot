...
- **02.05. (Sa) BRK.B Q1 FY26 — Tag-0 DONE** earnings-recap + 10-Q-Quick-Read + Tag-+1-Vorbereitungs-Brief + **Annual-Meeting-Q&A-File 02.05.** (CNBC Live-Feed via Sonnet) + **§19.1 BRK-Ausnahme-Klausel** in INSTRUKTIONEN (Issuer ohne Q-Call: Filing-Trigger, kein Wait-State). **Tag-+1 Mo 04.05. morgens fixiert** statt 03./04.05.-Range — Begründung: Mo-Open-Marktreaktion (Tech-Sub) + Zacks-EPS-Revisions-Refresh (Sentiment-Sub) + Insider-Form-4-Window für Abel-$15M-Stake-Verifikation + frischer Reviewer-Kopf nach Setup-Marathon. Score 75/D3 unverändert, kein FLAG.
