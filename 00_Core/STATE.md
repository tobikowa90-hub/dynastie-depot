...
- **05.05. (Di) Ruflo+Superpowers Coexistence Spec v1.0 USER-APPROVED (vorgezogen)** — Spec `docs/superpowers/specs/2026-05-05-ruflo-superpowers-coexistence-design.md` Final-R1 + Final-R2 Codex-Reviews abgeschlossen, User-Approval 05.05. abends statt 06.05. **Verdict-Bilanz:** HIGH-1 + HIGH-2 spec-intern closed (M1 Named-Trigger-Pflicht + G3 3-Felder-Konsistenz + C2.1 `CLAUDE.md`-Sync-Set für Plan-v1.2/Promotion/Deaktivierung); MED-2 closed (W3 Feld-Typen-Tabelle für alle 10 Felder). **2 Cross-File-Reststeller** als nicht-optionale Plan-v1.2-Pflicht-Carry-Forward in C5 verankert (R2-1 PIPELINE-#42-Sync-Set-Patch · R2-2 `CLAUDE.md` Z.124 Wortlaut-Harmonisierung) — beide blocking für Workflow-Promotion-Phase. **Nächste Aktion:** `superpowers:writing-plans` für Plan-v1.2 (PIPELINE #42) inkl. C5-Closure + Final-R1-MED/Gaps + 00_Core-Cleanup-Disziplin (User-Direktive: META-REVIEW.md nach `05_Archiv/` mit Plan-v1.2-Commit zusammen).
