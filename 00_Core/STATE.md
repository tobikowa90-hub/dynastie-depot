...
**Single Entry Point für Session-Start** | Stand: 20.04.2026 Nacht-Spät (**v3.0.3 Manual-Run 🔴 FAIL → Rollback v2.1 DEPLOYED** 15:13 UTC — Agent halluzinierte US-Ticker-Intraday-Kurse via unautorisiertem Yahoo-Fallback-Pfad (AVGO $317,79 phantom vs. real ~$388), Runtime 720s+; Gate A ausgesetzt; Prompt-Hotfix v3.0.4 in nächster Session mit explizitem Anti-Fallback-Guard; **6-Paper-Ingest-Projekt FORMAL ABGESCHLOSSEN**; **KG-Roadmap v0.1 `draft-frozen`**; **Discoverability-Edits** Update-Klassen-DEFCON + DEFCON-System + Depot-State-April-2026) | System: DEFCON v3.7 (unverändert)
