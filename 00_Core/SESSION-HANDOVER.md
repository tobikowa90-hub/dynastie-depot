...
### Backtest-Impact (keine DEFCON-Shifts)
| Ticker | v3.5 → v3.7 | DEFCON | Rate |
|--------|-------------|--------|------|
| ASML | 68 → 66 | 🟡 3 | 33,53€ |
| AVGO | 85 → 84 | 🟢 4 | 33,53€ (Insider-Review) |
| MSFT | 60 → 59 | 🟠 2 | 0€ (🔴 CapEx/OCF) |
| TMO | 62 → 63 | 🟠 2 | **16,76€** (D2 aus v3.5 Audit) |
| RMS | 69 → 68 | 🟢 4 | 33,53€ |
| VEEV | 74 → 74 | 🟢 4 | 33,53€ |
| SU | 71 → 69 | 🟢 4 | 33,53€ |
| BRK.B | 75 → 75 | 🟢 4 | 33,53€ |
| V | 86 → 86 | 🟢 4 | 33,53€ |
| APH | 61 → 63 | 🟡 3 | 0€ (🔴 Score-basiert) |
| COST | 69 → 69 | 🟢 4 | 33,53€ |

**Sparraten-Nenner:** 8×1.0 (D4/D3) + 1×0.5 (TMO D2) = **8.5** → 285€ / 8.5 = 33,53€ volle, 16,76€ D2.

> ⚠️ **Live-Verifikation pro Ticker** bei jedem nächsten Earnings-Update (QuickCheck-Pflicht) — Backtest war approx. basierend auf Interaktions-Redesign-Adjustment.
