...
**🛫 Phase-0b Pre-Flight-Checks (read-only, VOR Phase-0b-Execution abarbeiten — Ruflo-Gate-Prävention):**
...
**Default-Trigger:** „Session starten" → STATE.md + PORTFOLIO.md auto-load. **Phase 0b triggert User explizit per „Phase 0b starten"** (Pickup #A ✅ DONE 2026-05-16). Vor Phase-0b-Execution PF-1/PF-2-Pre-Flight-Block abarbeiten (PF-1 = USER-Decision Live-State-File-Set vor Task 18).
