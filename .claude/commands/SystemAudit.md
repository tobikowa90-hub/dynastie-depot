...
Default ohne $ARGUMENTS = --core (alle 8 Kern-Checks: jsonl_schema, store_freshness, markdown_header, cross_source, existence, skill_version, pipeline_ssot, log_lag — schreibt STATE.md Last-Audit-Block).
