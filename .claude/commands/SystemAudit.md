...
Default ohne $ARGUMENTS = --core (alle 10 Kern-Checks: jsonl_schema, store_freshness, markdown_header, cross_source, existence, skill_version, pipeline_ssot, log_lag, score_event_parity, skill_frontmatter — schreibt STATE.md Last-Audit-Block).
