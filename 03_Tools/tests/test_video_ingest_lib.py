...
def test_build_slug_lowercases_and_kebabs():
    assert (
        build_slug("2026-01-15", "Acquired", "NVIDIA Deep Dive")
        == "2026-01-15-acquired-nvidia-deep-dive"
    )


def test_build_slug_strips_special_chars():
    assert (
        build_slug("2026-04-22", "tmo", "Q1/FY26 Earnings — Call!")
        == "2026-04-22-tmo-q1-fy26-earnings-call"
    )
