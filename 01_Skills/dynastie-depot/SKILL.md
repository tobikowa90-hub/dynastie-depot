...
**Wissenschaftliche Fundierung (B29 Peters/Taylor 2017, eingeführt 2026-05-09 Phase D-1, präzisiert 2026-05-10 Phase-D-1-Confidence-Upgrade-Pass):** §410 ist KEIN ad-hoc-Heuristikum, sondern theoretisch fundiert. Peters & Taylor (2017, JFE 123(2), Voll-PDF NBER/SSRN-WP-Version 21.02.2016) zeigen: bei intangibles-dominierten Firmen (Tech/Healthcare/SaaS) ist die klassische Tobin's-q-Investment-Regression **misspezifiziert** (Prediction 4) — das Verhältnis K^tot/K^phy steckt im Residuum, korreliert negativ mit dem Regressor, was zu downward-biased q-slopes führt; der vermeintliche Befund „Investments sind nicht q-sensitiv" ist Mess-Artefakt. Total q (physisch + intangibles Capital) erklärt physische und intangible Investment-Rates besser (within-firm R² 20,9-32,7%). Brücke zu DEFCON via [[Crouzet-Eberly-Eisfeldt-Papanikolaou-2022-Economics-Intangible-Capital]] (JEP 36(3) 2022): die ökonomische Brücke „Goodwill = Lower-Bound für extern erworbenes Intangibles-Capital" stammt aus den zwei distinguishing properties Non-Rivalry in Use + Limited Excludability; bei M&A-Compoundern verschattet die GAAP-Klassifikation als Goodwill genau diese ökonomisch produktive Capital-Komponente. Rohe GAAP-ROIC mit Goodwill im Nenner doppelzählt (Goodwill ist im Zähler NOPAT bereits abgebildet, weil die Earnings aus dem Intangibles-Capital entstehen, das den Goodwill rechtfertigt). §410 ist die pragmatische Operationalisierung — Goodwill aus Invested Capital herausrechnen statt full Total-q-Capital-Reconstruction (PIM-Methode mit Branch-spezifischen Depreciation-Rates ist für 4-Min-Score-Routine prohibitiv). Die **40%-Goodwill-Asset-Schwelle** für §410-Dominanz über Regel-4 ist **NICHT** bei Peters/Taylor empirisch belegt — sie ist **DEFCON-eigene Kalibrierung** aus dem AVGO-30.04.-Präzedenzfall (PIPELINE #30 Closure); das Total-q-Framework legitimiert die Bereinigung wissenschaftlich, die Schwelle bleibt operative DEFCON-Konvention. Detail: [[Intangible-Adjusted-Value]] + [[Peters-Taylor-2017-Intangible-Capital]] + [[Crouzet-Eberly-Eisfeldt-Papanikolaou-2022-Economics-Intangible-Capital]] + [[Wissenschaftliche-Fundierung-DEFCON]] B29 `active-scoring-validation`.
...
4.  Erstelle Sparplan-Vorschlag (Umstrukturierung 2026-06-07, 60/35/5):
    ...
    - ETF-Core: 60% = 616€ (physisch ING: IWDA 206+EIMI 123+EXUS 82 = 411 · Scalable: AVGC 82+JEDI 72+WQTM 51 = 205)
...
**ETFs (ING):** IWDA, EIMI, EXUS | **(Scalable):** AVGC, JEDI, WQTM
**Gold:** EWG2 EUWAX Gold II (\~5%)
**Slots:** 13 Aktien + 6 ETF + Gold = 20 | **US-Cap:** 63%
**Sparrate:** ~1.031€/mtl (60/35/5) | **Broker:** ING (IWDA+EIMI+EXUS) + Scalable (AVGC/JEDI/WQTM + Satelliten + Gold)
