...
**Wissenschaftliche Fundierung (B29 Peters/Taylor 2017, eingeführt 2026-05-09 Phase D-1):** §410 ist KEIN ad-hoc-Heuristikum, sondern theoretisch fundiert. Peters & Taylor (2017, JFE 123(2)) zeigen: klassisches Tobin's q ist Mess-Artefakt, weil es nur physisches Capital im Nenner berücksichtigt; bei intangibles-dominierten Firmen (Tech/Healthcare/SaaS) ist Total q (physisch + intangibles Capital) die korrekte Größe — Hayashi-Bedingung wird unter Total q nicht abgelehnt, unter klassischem Tobin's q schon. Brücke zu DEFCON via Crouzet/Eberly (2019): bei M&A-Compoundern ist Bilanz-Goodwill eine Lower-Bound-Approximation für extern erworbenes Intangibles-Capital; rohe GAAP-ROIC mit Goodwill im Nenner doppelzählt (Goodwill ist im Zähler NOPAT bereits abgebildet, weil die Earnings aus dem Intangibles-Capital entstehen, das den Goodwill rechtfertigt). §410 ist die pragmatische Operationalisierung dieser Logik — Goodwill aus Invested Capital herausrechnen statt full Total-q-Capital-Reconstruction (PIM-Methode mit Branch-spezifischen Depreciation-Rates ist für 4-Min-Score-Routine prohibitiv). Die 40%-Goodwill-Asset-Schwelle für §410-Dominanz über Regel-4 ist ökonomisch begründet: bei extremen Goodwill-Anteilen ist die externe Intangibles-Akquisition strukturell, nicht kosmetisch. Detail: [[Intangible-Adjusted-Value]] + [[Wissenschaftliche-Fundierung-DEFCON]] B29 `active-scoring-validation`.
