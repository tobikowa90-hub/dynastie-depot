...
stand: "03.04.2026"
description: >
Referenz-Analysen zur Kalibrierung des DEFCON v3.2 Scoring-Systems (AVGO 86, MKL 82, SNPS 79). MUSS vor jeder neuen !Analysiere-Analyse gelesen werden, um konsistente Scores sicherzustellen.
trigger_words:
- Kalibrierung
- Referenz-Analysen
- AVGO
...
- FICO
---
# 🔬 Referenz-Analysen – Analyse-Labor DEFCON v3.2

**Zweck:** Kalibrierungsanker für konsistentes Scoring | **Stand:** 02.04.2026

## 📌 Verwendung dieser Datei

*   **Vor jeder neuen Analyse** kurz die Referenz-Scores checken
*   Eigene Scores gegen AVGO (86) und MKL (82) kalibrieren
*   SNPS (79) als Grenzfall-Referenz für DEFCON 3/4-Entscheidung
*   TMO (65) als Referenz für Wide Moat mit ROIC < WACC + Akquisitionsschulden
*   EXPN (61) als Referenz für Watchlist-Kandidaten mit Datenlücken

## 🥇 AVGO – Broadcom Inc. | Score: 86/100 | 🟢 DEFCON 4
...
| Technicals | 8/10 | -30% von ATH, Ø PT $460 (+44%) |
...
→ Kalibrierungsanker bleibt bei 86 — nächste Vollanalyse bei Q3 FY26 Earnings

**Nächste Aktion:** !CAPEX-FCF-ANALYSIS AVGO Broadcom ✅ (bereits durchgeführt) **Status:** 🟢 Aktiv im Depot – Sparplan läuft

**Scoring-Lektion:** Fabless-Modell = automatisch 9/9 CapEx/OCF. AI-Backlog $73B = Visibility-Bonus bei Sentiment. Referenz für „wie sieht 86/100 aus".
...
| Technicals | 6/10 | +28% 1Y, DCF $1.475 (-13% Downside) |
...
## 🥉 SNPS – Synopsys Inc. | Score: 79/100 | 🟡 DEFCON 3
...
| Technicals | 7/10 | -33% von ATH, Ø PT $562 (+28%) |
...
## 🔵 SPGI – S&P Global Inc. | Score: 77/100 | 🟡 DEFCON 3
...
| Technicals | 7/10 | -30% von ATH, Morningstar FV $570 (+22% Upside), unter 200D-MA |
...
## 🔬 TMO – Thermo Fisher Scientific | Score: 65/100 | 🟡 DEFCON 3
...
| Technicals | 7/10 | -29.4% von ATH ($670), Ø PT $667.50 (+41%), aber unter 200D-MA |
...
## 💱 FICO - Fair Isaac Corp. | Score 70/100 | 🟡 DEFCON 3
...
| Technicals | 7/10 | -52% ATH, PT Upside +100%; unter 200D-MA (0/3) |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| AVGO | 86/100 | 🟢 4 | 25.03.2026 | Aktiv | ✅ | Sparplan läuft |
| MKL | 82/100 | 🟢 4 | 25.03.2026 | Ersatzbank | ✅ | CapEx-FCF (Perf.) |
| SNPS | 79/100 | 🟡 3 | 26.03.2026 | Ersatzbank | ✅ | Re-Analyse Mai 26 |
| SPGI | 77/100 | 🟡 3 | 31.03.2026 | Watchlist | ✅ | Earnings 28.04.2026 |
| MSFT | 77/100 | 🟡 3 | 26.03.2026 | Aktiv | 🔴 CapEx/OCF 65.3% | Re-Check 29.04.2026 |
| GOOGL | 72/100 | 🟡 3 | 26.03.2026 | — | 🔴 CapEx FY26 ~75% OCF | Kein Einstieg |
| HON | 71/100 | 🟡 3 | 28.03.2026 | — | ✅ | Post-Spinoff 2026 |
| TMO | 65/100 | 🟡 3 | 02.04.2026 | Aktiv | ⚠️ Clario-Watch | Re-Analyse 23.04.2026 |
